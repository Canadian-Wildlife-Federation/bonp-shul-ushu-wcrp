...
connect = api.watershed_connectivity("ALL", 'BONP')[0]
total = round(api.watershed_connectivity("ALL", 'BONP')[1],2) #total km in watershed
access = round(api.watershed_connectivity("ALL", 'BONP')[2],2)
